...
function throwSeveral() {
  return __awaiter(this, void 0, void 0, function () {
    var msg1, msg2, msg3, error_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 4, , 5]);
          return [4 /*yield*/, (0, read_js_1.read)('foo1', false)];
        case 1:
          msg1 = _a.sent();
          console.log(elapsed(), 'throwSeveral1:', msg1);
          return [4 /*yield*/, (0, read_js_1.read)('foo2', false)];
        case 2:
          msg2 = _a.sent();
          console.log(elapsed(), 'throwSeveral2:', msg2);
          return [4 /*yield*/, (0, read_js_1.read)('foo3', false)];
        case 3:
          msg3 = _a.sent();
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4 /*yield*/, (0, read_js_1.read)(msg1, false)];
        case 2:
          msg2 = _a.sent();
          console.log(elapsed(), 'throwChained2:', msg2);
          return [4 /*yield*/, (0, read_js_1.read)(msg2, false)];
        case 3:
          msg3 = _a.sent();
...
(function run() {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, throwOnce()];
        case 1:
          _a.sent();
          return [4 /*yield*/, throwSeveral()];
        case 2:
          _a.sent();
          return [4 /*yield*/, throwChained()];
        case 3:
          _a.sent();
          return [2 /*return*/];
      }
